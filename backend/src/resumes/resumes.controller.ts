import { Controller, Post, Put, UseGuards, Body, Request, Get, Param, ForbiddenException, UseInterceptors, UploadedFile, Delete } from '@nestjs/common';
...
export class ResumesController {
  ...
  async update(
    ...
    if (file) {
      resumeData.photo = `/api/uploads/${file.filename}`;
    } else if (resume.data?.photo) {
      resumeData.photo = resume.data.photo;
    }

    return this.resumesService.update(resumeId, resumeData);
  }
